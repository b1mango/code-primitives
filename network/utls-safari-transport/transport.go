...
// NewSafariClient returns a standard *http.Client configured with Safari TLS ClientHello
// fingerprinting and dynamic ALPN rewriting to HTTP/1.1 to bypass WAF TLS/H2 fingerprint checks.
func NewSafariClient(timeout time.Duration, dialContext DialContextFunc) *http.Client {
...
// ForceHTTP11ALPN rewrites the ALPN extension of the ClientHello to only request http/1.1.
// This sidesteps complex HTTP/2 frame and flow-control finger-printing.
