// Package pow provides a pure Go implementation of DeepSeekHashV1 and its PoW solver.
// DeepSeekHashV1 is based on SHA3-256 with rate=136 and output=32 bytes,
// but skips Keccak-f[1600] round 0 (executing only rounds 1..23).
package pow
...
// keccakF23 executes Keccak-f[1600] permutation skipping round 0 (rounds 1 to 23).
...
// DeepSeekHashV1 computes 32-byte digest of data using rate=136 padding 0x06...0x80.
